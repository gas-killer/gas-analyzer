...
- **Analyzed**: 20 (the run cap), chosen by hand for shape and size diversity — the one liquidation in range, flash-loan leverage/deleverage, signature-authorised bundler multicalls, public-allocator `reallocate` calls, multi-market vault reallocations (2–11 markets), direct Morpho Blue entrypoint calls, and flash-loan-only MEV bots. Gas spread 99,912–1,779,190, weighted toward the 100 k–600 k mid-range.
...
|---:|---|---:|---|---|---:|---:|---:|---:|---:|---:|---|---|
| 1 | [`0xcd59750e…`](https://etherscan.io/tx/0xcd59750e91859ec6af4209c588997b61962dcec2aad6c549ef35324476870bdf) | 25774397 | `0xc54b4e08…` | Public-allocator style `reallocate(((address,address,address,address,uint256),uint256)[])` (selector verified): 4-market `Supply`+`Withdraw` 🟢 **SCHNORR-ONLY** | 324,608 | 253,881 | 70,727 | 280,881 | **43,727** (13.47%) | 0 (0.00%) | ⚠️ **heuristic** | 15: Call×10, Log3×5 |
| 2 | [`0x4e547494…`](https://etherscan.io/tx/0x4e547494fcf332b50465117a6467c8cb097787e4b54fd5b97ff6ff5cfec96ceb) | 25774052 | `0x5af8b1e9…` | Flash-loan leverage open: `FlashLoan`+`SupplyCollateral`+`Borrow`, 12,324 B calldata (label from events; selector `0x642ba7a7` not identified) 🟢 **SCHNORR-ONLY** | 1,779,190 | 1,720,040 | 59,150 | 1,747,040 | **32,150** (1.81%) | 0 (0.00%) | trace | 6: Store×3, Call×2, Log1×1 |
| 3 | [`0x80329618…`](https://etherscan.io/tx/0x80329618f5c5261829097e2a8a079c765c6ae0ce35f6d98e09a4d246a694c8bf) | 25774472 | `0x3a618e9d…` | Bundler `multicall(bytes[])` (selector verified): 2-market `Supply`+`Withdraw` reallocation 🟢 **SCHNORR-ONLY** | 380,049 | 343,154 | 36,895 | 370,154 | **9,895** (2.60%) | 0 (0.00%) | trace | 18: Store×10, Call×4, Log3×3, Log1×1 |
| 4 | [`0x1c71eb76…`](https://etherscan.io/tx/0x1c71eb76549cc6a80467e06e8bc938b7fc1e67e9575c2aece8d98345243bb218) | 25774086 | `0x9e9110cf…` | 9-market reallocation: `Supply`+`Withdraw`+`AccrueInterest` across 9 market ids (label from events; selector `0xeb7499cf` not identified)  | 725,295 | 699,768 | 25,527 | 726,768 | **0** (0.00%) | 0 (0.00%) | trace | 1: Call×1 |
| 5 | [`0x9a08a526…`](https://etherscan.io/tx/0x9a08a526e05f5fe827840f0ec4e3d1ce31906fa5a7a9bda7677098e4d78903df) | 25774239 | `0x00000f91…` | Flash-loan-only MEV/arb bot: single `FlashLoan` event (label from event; selector `0x03f00196` not identified)  | 420,293 | 414,721 | 5,572 | 441,721 | **0** (0.00%) | 0 (0.00%) | ⚠️ **heuristic** | 5: Call×5 |
| 6 | [`0x8e4616ac…`](https://etherscan.io/tx/0x8e4616acfaf812a41b471e139924a1bc906e03e8e1203760ae6117113682b760) | 25774072 | `0x64c18dcc…` | Bundler `multicall(bytes[])` (selector verified): 2-market `Supply`+`Withdraw` reallocation  | 312,814 | 314,184 | -1,370 | 341,184 | **0** (0.00%) | 0 (0.00%) | trace | 18: Store×10, Call×4, Log3×3, Log1×1 |
| 7 | [`0x8d0c4018…`](https://etherscan.io/tx/0x8d0c40187a36dd2de2b64800b87d8db9b235624479d35202a11c2b2fb98fd76a) | 25774169 | `0x4095f064…` | Bundler `multicall(bytes[])` (selector verified): single-market `Supply`+`AccrueInterest`  | 157,756 | 161,582 | -3,826 | 188,582 | **0** (0.00%) | 0 (0.00%) | trace | 5: Call×3, Store×2 |
| 8 | [`0x50305a21…`](https://etherscan.io/tx/0x50305a216cbeabbc02ad2262619090e91c6928ecc30def46af4eaab7bde99e9b) | 25774272 | `0x4095f064…` | Bundler `multicall(bytes[])` (selector verified): single-market `Supply`+`AccrueInterest`  | 179,644 | 183,470 | -3,826 | 210,470 | **0** (0.00%) | 0 (0.00%) | trace | 5: Call×3, Store×2 |
| 9 | [`0x2d7cebfe…`](https://etherscan.io/tx/0x2d7cebfe726192fe692ccfa905b401fdedb108f5a3ecdf34aff20d2e77b3c320) | 25774308 | `0x65661941…` | Router call emitting only `SupplyCollateral` (label from event; selector `0x374f435d` not identified)  | 122,812 | 126,798 | -3,986 | 153,798 | **0** (0.00%) | 0 (0.00%) | ⚠️ **heuristic** | 3: Call×3 |
| 10 | [`0x3dffb38b…`](https://etherscan.io/tx/0x3dffb38b03f52c07073a0ad32f336c5d3106640c2462f72204c9d6fe02534ed1) | 25774475 | `0x4095f064…` | Bundler `multicall(bytes[])` (selector verified): signature-authorised position open — `SetAuthorization`+`IncrementNonce`+`SupplyCollateral`+`Borrow`  | 360,323 | 371,754 | -11,431 | 398,754 | **0** (0.00%) | 0 (0.00%) | trace | 8: Call×6, Store×2 |
| 11 | [`0xdc74e020…`](https://etherscan.io/tx/0xdc74e020e296fbb968edfc2ffd630bad47d557c71dabe901938315be6329c5c9) | 25774018 | `0x65661941…` | Same router selector `0x374f435d`, this time `Repay`+`AccrueInterest` (label from events)  | 134,366 | 148,620 | -14,254 | 175,620 | **0** (0.00%) | 0 (0.00%) | ⚠️ **heuristic** | 2: Call×2 |
...
| 17 | [`0xbeffded8…`](https://etherscan.io/tx/0xbeffded8df725752edea428f171d8ec2a842dcdb645977ea9cf5bedba14ca414) | 25774418 | `0x68aea7b8…` | Public-allocator style `reallocate(((address,address,address,address,uint256),uint256)[])` (selector verified): 5-market `Supply`+`Withdraw`  | 416,744 | 451,366 | -34,622 | 478,366 | **0** (0.00%) | 0 (0.00%) | trace | 18: Call×12, Log3×6 |
...
1. `0xcd59750e91859ec6af4209c588997b61962dcec2aad6c549ef35324476870bdf`
2. `0x4e547494fcf332b50465117a6467c8cb097787e4b54fd5b97ff6ff5cfec96ceb`
3. `0x80329618f5c5261829097e2a8a079c765c6ae0ce35f6d98e09a4d246a694c8bf`
4. `0x1c71eb76549cc6a80467e06e8bc938b7fc1e67e9575c2aece8d98345243bb218`
5. `0x9a08a526e05f5fe827840f0ec4e3d1ce31906fa5a7a9bda7677098e4d78903df`
6. `0x8e4616acfaf812a41b471e139924a1bc906e03e8e1203760ae6117113682b760`
7. `0x8d0c40187a36dd2de2b64800b87d8db9b235624479d35202a11c2b2fb98fd76a`
8. `0x50305a216cbeabbc02ad2262619090e91c6928ecc30def46af4eaab7bde99e9b`
9. `0x2d7cebfe726192fe692ccfa905b401fdedb108f5a3ecdf34aff20d2e77b3c320`
10. `0x3dffb38b03f52c07073a0ad32f336c5d3106640c2462f72204c9d6fe02534ed1`
11. `0xdc74e020e296fbb968edfc2ffd630bad47d557c71dabe901938315be6329c5c9`
12. `0x1338ba16b0a7f61988caf43896fde0e32edac97cd7dab32bb6136bf9e77f0302`
...
|---|---|---:|---:|---:|---:|---:|---|
| `0xcd59750e91859ec6…` | Public-allocator style `reallocate(((address,address,address,address,uint256),uint256)[])` (selector verified): 4-market `Supply`+`Withdraw` | 324,608 | 253,881 | **70,727** | **43,727** (13.47%) | 0 | ⚠️ heuristic |
...
- `0xcd59750e91859ec6af4209c588997b61962dcec2aad6c549ef35324476870bdf` — surplus **70,727**, i.e. 43,727 gas above the Schnorr floor and 179,273 gas below the BLS floor.
...
**0 of 20** transactions cleared the 250,000 BLS floor. **3 of 20** cleared the 27,000 Schnorr floor. Every single win in this sample is a Schnorr-only win — the 223,000-gas band is doing all of the work here. On this evidence, Morpho is a protocol GasKiller can only address with the cheaper signature scheme.

### The controlling variable is surplus, and surplus is usually negative

Surplus (`gas_used − base_estimate`) ranged from -265,037 to 70,727. **15 of 20 were negative** — replaying the final state diff costs *more* than the original transaction spent. That is the opposite of what GasKiller needs, and it is the normal case for Morpho.
...
- **`0xcd59750e91859ec6…`** — Public-allocator style `reallocate(((address,address,address,address,uint256),uint256)[])` (selector verified): 4-market `Supply`+`Withdraw`. surplus **70,727**, 15 updates (`Call`×10, `Log3`×5), Schnorr **43,727** (13.47%)  ⚠️ **heuristic estimate**.
...
The catch, and it is a big one: the two trace-based winners save only **1.81%** and **2.60%**. The only double-digit result (13.47%) is a heuristic estimate and should not be trusted at that magnitude. So while Schnorr-only candidates exist in Morpho, the ones measured properly here are *thin* wins, not dramatic ones.

### What the zero-savings ones have in common

- **diffs containing `Store` writes** (9 txs): surplus -179,518 … -1,370.
- **`Call`-only / `Call`+`Log`-only diffs** (8 txs): surplus -265,037 … 25,527.
...
**6 of 20 transactions (30%) did not produce a measured `StateChangeHandler` replay.** The CLI labelled these itself as heuristic; the figures are much softer and must not be read as equivalent to the trace-based rows:

| tx | analyzer's own label | gas_used | base_estimate | surplus | Schnorr saved | state updates |
|---|---|---:|---:|---:|---:|---|
| `0xcd59750e91859ec6…` | *heuristic - measured estimation failed* | 324,608 | 253,881 | 70,727 | 43,727 | 15: `Call`×10, `Log3`×5 |
...
- **The single best-looking result in this whole survey is a heuristic one.** `0xcd59750e…` (public-allocator `reallocate`, 13.47% Schnorr savings) rests on a fallback estimate with a `Call`×10 + `Log3`×5 diff and **no `Store` updates at all**, which is itself suspicious for a transaction that demonstrably moved liquidity across 4 markets. Treat the 13.47% as a lead to re-measure, **not** as a result. The two defensible wins are the trace-based 1.81% and 2.60%.
...
- **A 30% heuristic-fallback rate undermines a substantial part of the sample.** 6 of 20 transactions, including the highest-scoring one and the only liquidation, were not measured through the real replay path.
