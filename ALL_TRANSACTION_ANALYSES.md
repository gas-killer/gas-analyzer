...
| Doppler | [`0x7b08cf0d…`](https://etherscan.io/tx/0x7b08cf0df79aaaf918bc03d62d402bceb70e3ac68e662a18464c3097d02071ff) | DopplerHookInitializer `collectFees` ✓ `0x817db73b` | 913,547 | 738,099 | +175,448 | **125,448** (13.73%) | 0 | — | — | the v4 `unlock` call re-executes at full price; the saving is the hook's own work around it |
| Doppler | [`0xd5641848…`](https://etherscan.io/tx/0xd5641848c47452bb10d524757bf72e48fb1666fa1167243ac1f3d2d2d592ca5a) | DopplerHookInitializer `collectFees` ✓ `0x817db73b` | 1,077,254 | 964,620 | +112,634 | **62,634** (5.81%) | 0 | — | — | the v4 `unlock` call re-executes at full price; the saving is the hook's own work around it |
| Doppler | [`0x7e6d047f…`](https://etherscan.io/tx/0x7e6d047f258d4e7c5aca564589fe7534010d0cac5ffb3558fe3489e3fb3ab8c8) | DopplerHookInitializer `collectFees` ✓ `0x817db73b` | 1,697,427 | 1,595,254 | +102,173 | **52,173** (3.07%) | 0 | — | — | the v4 `unlock` call re-executes at full price; the saving is the hook's own work around it |
| Doppler | [`0xa031529c…`](https://etherscan.io/tx/0xa031529cf96eb00c71b8ca2e0617f12498f27659a2038757897c63e6276101af) | DopplerHookInitializer `collectFees` ✓ `0x817db73b` | 332,007 | 276,506 | +55,501 | **5,501** (1.66%) | 0 | — | — | the v4 `unlock` call re-executes at full price; the saving is the hook's own work around it |
| Doppler | [`0xe4d77117…`](https://etherscan.io/tx/0xe4d771177d430cfd07a99ae434945646001b7695f34b63302aad94870bca1898) | DopplerHookInitializer `collectFees` ✓ `0x817db73b` | 576,481 | 527,783 | +48,698 | **0** | 0 | under the floor | — | the v4 `unlock` call re-executes at full price; the saving is the hook's own work around it |
| Doppler | [`0x4593f0f9…`](https://etherscan.io/tx/0x4593f0f9e436d1266a77e8a2465c16cb84264b138bacf1b5edf14e2a51bee4cc) | Airlock `migrate` ✓ `0xce5494bb` | 1,521,053 | 1,534,510 | -13,457 | **0** | 0 | replay costs more | — | replay costs more; no calls left after migration |
| Doppler | [`0x7b024728…`](https://etherscan.io/tx/0x7b024728c995fe928ef0b13e4a1f3236966836997740aa2a9ed50d264faf2645) | Airlock `migrate` ✓ `0xce5494bb` | 1,514,716 | 1,533,191 | -18,475 | **0** | 0 | replay costs more | — | replay costs more; no calls left after migration |
| Doppler | [`0x7b45e98b…`](https://etherscan.io/tx/0x7b45e98bd0476aa74aea50285a21d49ab11916c1f29bb004b9e398c73ecb746c) | Airlock `migrate` ✓ `0xce5494bb` | 1,429,881 | 1,443,302 | -13,421 | **0** | 0 | replay costs more | — | replay costs more; no calls left after migration |
| Doppler | [`0x2625faaf…`](https://etherscan.io/tx/0x2625faaf8cb03973648d805c20cc935b05e9c699ba3a5f3c8aef8908c5279197) | Airlock `create` ✓ `0x882db707` `heur` | 3,211,370 | 3,203,260 | +8,110 | **0** | 0 | under the floor | — | `heur` — the heuristic **understates** base, so this surplus is an **upper bound**; orchestration only — every module call is a `CALL`; surplus flat at ~8–12k regardless of size |
| Doppler | [`0x59dca1e4…`](https://etherscan.io/tx/0x59dca1e473545400919939870ef08f234dc3f63488ff54b7a8ea5b8c59c0ab98) | Airlock `create` ✓ `0x882db707` `heur` | 3,991,660 | 3,983,174 | +8,486 | **0** | 0 | under the floor | — | `heur` — the heuristic **understates** base, so this surplus is an **upper bound**; orchestration only — every module call is a `CALL`; surplus flat at ~8–12k regardless of size |
| Doppler | [`0x6ebee3ee…`](https://etherscan.io/tx/0x6ebee3ee614dcddcc64aa9374ab9b047036609ca7b74d3bb367ba4b4b5081fda) | Airlock `create` ✓ `0x882db707` `heur` | 3,101,823 | 3,093,659 | +8,164 | **0** | 0 | under the floor | — | `heur` — the heuristic **understates** base, so this surplus is an **upper bound**; orchestration only — every module call is a `CALL`; surplus flat at ~8–12k regardless of size |
| Doppler | [`0x80f2502e…`](https://etherscan.io/tx/0x80f2502e93bf2f745a9ccf7c3e0a574a43811eedcf2e4a919c1cdad337b55bcd) | Airlock `create` ✓ `0x882db707` `heur` | 3,041,291 | 3,033,187 | +8,104 | **0** | 0 | under the floor | — | `heur` — the heuristic **understates** base, so this surplus is an **upper bound**; orchestration only — every module call is a `CALL`; surplus flat at ~8–12k regardless of size |
| Doppler | [`0x2a32239b…`](https://etherscan.io/tx/0x2a32239b96cb56b16bf50d12e50abbfa7062242397c75f1b2ab137acdd8e0c0f) | Airlock `create` ✓ `0x882db707` `heur` | 2,312,663 | 2,320,040 | -7,377 | **0** | 0 | replay costs more | — | `heur` — the heuristic **understates** base, so this surplus is an **upper bound**; orchestration only — every module call is a `CALL`; surplus flat at ~8–12k regardless of size |
| Doppler | [`0x730b0c9f…`](https://etherscan.io/tx/0x730b0c9f5f1c272b054f132459d81802950f04b74f7f8342718885c71134b250) | Airlock `create` ✓ `0x882db707` `heur` | 7,544,634 | 7,534,130 | +10,504 | **0** | 0 | under the floor | — | `heur` — the heuristic **understates** base, so this surplus is an **upper bound**; orchestration only — every module call is a `CALL`; surplus flat at ~8–12k regardless of size |
| Doppler | [`0x522cdff0…`](https://etherscan.io/tx/0x522cdff009832ae3d86c44456e7dd32ce4f80f797c554425854ce8d739c2a4c9) | Airlock `create` ✓ `0x882db707` `heur` | 2,268,794 | 2,276,171 | -7,377 | **0** | 0 | replay costs more | — | `heur` — the heuristic **understates** base, so this surplus is an **upper bound**; orchestration only — every module call is a `CALL`; surplus flat at ~8–12k regardless of size |
...
| Privacy Pools | [`0x3585c6e3…`](https://etherscan.io/tx/0x3585c6e357bdf24f500f595ae26d61217c9a1ccc8f911de9e808df32e2d1bfd1) | PoolVault `0x0eb42804…` `0x769284c2` | 485,882 | 160,863 | +325,019 | **275,019** (56.60%) | 75,019 | — | — | the contract that runs the pairing check; only child is a DELEGATECALL, which replay follows |
| Privacy Pools | [`0x83d92882…`](https://etherscan.io/tx/0x83d928821a47b6fe8b0002b567c6cd32ea6b111a493ecdacf89c06134fdcacc6) | PoolVault `0x0eb42804…` `0x769284c2` | 485,918 | 160,863 | +325,055 | **275,055** (56.60%) | 75,055 | — | — | same base to the gas as the row above |
